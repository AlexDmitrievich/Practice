...
public class MainFrame implements ActionListener{
    ...
    static String  helpArr1="\n     Систему разработал студент группы ИВТ/б-21-1-о\n "+
            "    Гапоненко Андрей Юрьевич:\n"+"     СевГУ - 2022.\n";

    static String  helpArr2="\n     Информационная система осуществляет хранение и\n"+
            "     обработку данных об учебном плане \n"+"     кафедры.\n" ;
    public   MainFrame(){
        Global.table = new ResultGroup("Список записей об учебном плане");
        ...
        myC.add(new JLabel("Учебный план кафедры", JLabel.CENTER),
                BorderLayout.NORTH);
        MSG = new JLabel("   Курсовой проект по дисциплине \"Программирование\". СевГУ - 2022");
    ...
    public void NewFile(){
        Global.table.getSchedules().clear();
    ...
    public void OpenFile(){
        ...
        if (rez==fch.APPROVE_OPTION){
            ...
            java.util.List <Result> s1 = Transfer.StringsToResults(LINES);
            Global.table.getSchedules().clear();
            for (Result s2: s1) Global.table.addSchedule(s2);
    ...
    public void SaveFile(boolean fs){
        ...
        if  (curFile==null){MSG.setText(
                "   Файл для сохранения не выбран"); return;}
        if ((!curFile.exists())|| fileName.equals(old_file_name)){
            LINES = Transfer.ResultsToString(Global.table.getSchedules());
            try{
        ...
        MSG.setText(
                "   Курсовой проект по дисциплине \"Программирование\". СевГУ - 2022");}
    ...
    public void actionPerformed (ActionEvent e){
        ...
        if("Новый".equals(e.getActionCommand()))NewFile();
            ...
            HelpDialog helpMSG = new HelpDialog(MainFrame.frame,"О программе",helpArr1, "111.gif");
